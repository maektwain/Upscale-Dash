...
public class CollateralApiConstants {
    ...
    public static enum COLLATERAL_JSON_INPUT_PARAMS {
        LOAN_ID("loanId"), COLLATERAL_ID("collateralId"), COLLATERAL_TYPE_ID("collateralTypeId"),GOLD_FINENESS_TYPE_ID("goldfineTypeId"),JEWELLERY_KIND_TYPE_ID("jewelleryTypeId"),GROSS_WEIGHT("gross"),IMPURITY_WEIGHT("impurity"),NET_WEIGHT("net"),STONE_WT("stone"), VALUE("value"), DESCRIPTION("description");
