...
public class CollateralsApiResource {
    ...
    private static final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "type","goldfine","jewellery","gross","impurity", "net","stone","value", "description",
    ...
    public String newCollateralTemplate(@Context final UriInfo uriInfo) {
        ...
        final CollateralData collateralData = CollateralData.template(codeValues,goldfineValues,jewelleryValues);
    ...
    public String retrieveCollateralDetails(@Context final UriInfo uriInfo, @PathParam("loanId") final Long loanId,
        ...
        if (settings.isTemplate()) {
            ...
            CollateralData = CollateralData.template(CollateralData, codeValues, goldfineValues,jewelleryValues);
        }
