...
public class CollateralCommand {
    ...
    public CollateralCommand(final Long collateralTypeId,final Long goldfineTypeId, final Long jewelleryTypeId,final BigDecimal value,final BigDecimal gross,final BigDecimal impurity,final BigDecimal net, final BigDecimal stone, final String description) {
