...
public class LoanCollateral extends AbstractPersistable<Long> {
    ...
    public static LoanCollateral from(final CodeValue collateralType,final CodeValue goldfineType,final CodeValue jewelleryType, final BigDecimal value, final BigDecimal gross,final BigDecimal impurity, final BigDecimal net, final BigDecimal stone, final String description) {
        return new LoanCollateral(null, collateralType,goldfineType,jewelleryType, value,impurity, net, stone,gross, description);
    }
    ...
    private LoanCollateral(final Loan loan, final CodeValue collateralType,final CodeValue goldfineType,final CodeValue jewelleryType, final BigDecimal value, final BigDecimal gross,final BigDecimal impurity, final BigDecimal net, final BigDecimal stone,final String description) {
        this.loan = loan;
    ...
    public void assembleFrom(final CodeValue collateralType,final CodeValue goldfineType,final CodeValue jewelleryType, final BigDecimal value,final BigDecimal gross,final BigDecimal impurity, final BigDecimal net, final BigDecimal stone, final String description) {
        this.type = collateralType;
        this.goldfine = goldfineType;
        this.jewellery = jewelleryType;
    ...
    public static LoanCollateral fromJson(final Loan loan, final CodeValue collateralType,final CodeValue goldfineType, final CodeValue jewelleryType, final JsonCommand command) {
        ...
        return new LoanCollateral(loan, collateralType,goldfineType,jewelleryType, value,gross,impurity,net,stone, description);
    }
    ...
    public CollateralData toData() {
        ...
        return CollateralData.instance(getId(), typeData,goldfineData,jewelleryData, this.value,this.gross,this.impurity,this.net,this.stone, this.description, null);
    }
