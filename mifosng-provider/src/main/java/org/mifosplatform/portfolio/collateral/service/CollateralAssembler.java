        ...
        if (element.isJsonObject()) {
            ...
            if (topLevelJsonElement.has("collateral") && topLevelJsonElement.get("collateral").isJsonArray()) {
                ...
                for (int i = 0; i < array.size(); i++) {
                    ...
                    if (id == null) {
                        collateralItems.add(LoanCollateral.from(collateralType,goldfineType,jewelleryType, value,gross,impurity,net,stone, description));
                    } else {
                        ...
                        loanCollateralItem.assembleFrom(collateralType,goldfineType,jewelleryType, value,gross,impurity,net,stone, description);
