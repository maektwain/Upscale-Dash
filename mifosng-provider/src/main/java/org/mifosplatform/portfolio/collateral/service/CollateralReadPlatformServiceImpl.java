...
public class CollateralReadPlatformServiceImpl implements CollateralReadPlatformService {
    ...
    private static final class CollateralMapper implements RowMapper<CollateralData> {
        ...
        private final StringBuilder sqlBuilder = new StringBuilder(
                "lc.id as id, lc.description as description, lc.value as value, lc.gross as gross, lc.impurity as impurity, lc.net as net, lc.stone as stone,cv.id as typeId, gf.id as goldfineId,jw.id as jewelleryId, cv.code_value as typeName,gf.code_value as goldfineName,jw.code_value as jewelleryName, oc.code as currencyCode, ")
        ...
        public CollateralData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return CollateralData.instance(id, type,goldfine,jewellery, value, gross,stone,impurity,net,description, currencyData);
        }
    }
